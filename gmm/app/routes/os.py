...
from app.models.terceirizados_models import HistoricoNotificacao # Certifique-se que está importado
from app.tasks.whatsapp_tasks import enviar_whatsapp_task # Certifique-se que está importado
